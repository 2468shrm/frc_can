...
from intake_single_sensor_2023 import INTAKE_SINGLE_SENSOR_2023
...
dist_sensor = INTAKE_SINGLE_SENSOR_2023(i2c0=i2c0,
                                      real_sensor_distance=37.0,
                                      do_calibrate=True,
                                      filter=True, debug=False,
                                      calibrate_log=True)
...
FILTER_ENABLE_MSG = FRCCANDevice(
            ...
            api=INTAKE_SINGLE_SENSOR_2023.INTAKE_SENSOR_2023_FILTER_ENABLE,
            device_number=1)
FILTER_DISABLE_MSG = FRCCANDevice(
            device_type=FRCCANDevice.DEVICE_TYPE_MISCELLANEOUS,
            manufacturer=FRCCANDevice.MANUFACTURER_TEAM_USE,
            api=INTAKE_SINGLE_SENSOR_2023.INTAKE_SENSOR_2023_FILTER_DISABLE,
            device_number=1)
